...
int main()
{
    ...
    g_bridge->addSubscriber<control_msgs::msg::EgoVehicleCommand,
                            control_msgs::msg::EgoVehicleCommandPubSubType>(
        "rt/control/ACCEgoVehCmd", topicEgoVehicleCommandCallback);
